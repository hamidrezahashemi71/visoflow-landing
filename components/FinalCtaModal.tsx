    ...
    >
      ...
      >
        <button
          ...
          onClick={() => setOpen(false)}
          aria-label="بستن"
          className="absolute top-3 left-1 z-1 inline-flex h-9 w-9 items-center justify-center rounded-full bg-bg-deep/40 text-text-soft backdrop-blur-sm transition-colors hover:bg-bg-deep/70 hover:text-text"
        >
